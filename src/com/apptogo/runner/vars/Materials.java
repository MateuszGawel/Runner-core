...
public class Materials {
	...
	{
		//player
		characterBody = createFixtureDef(12f, 0.3f, 0f, BIT_CHARACTER, (short)(BIT_TERRAIN | BIT_WORLD_OBJECT | BIT_ABILITY), false); //postaæ
		...
		bodyMemberBody = createFixtureDef(10f, 0.5f, 0.1f, BIT_WORLD_OBJECT, (short)(0), false); //czesci cia³a
		...
		obstacleSensor = createFixtureDef(0.1f, 1f, 0.8f, BIT_WORLD_OBJECT, (short)(BIT_CHARACTER | BIT_CHARACTER_SENSOR | BIT_WORLD_OBJECT), true); //wystarczy jesli przeszkoda jest statyczna
